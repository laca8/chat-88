...
const user =JSON.parse(localStorage.getItem('user'))
  ...
  const handleImageUpload = async (e) => {
    ...
    if (!file) return;
      ...
      const res = await axios.put('/api/auth/profile', {profilePic:selectedImg},config)
        console.log(res);
    setLoad(false)
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              ...
              <label
                ...
                className={`
                  ...
                  ${load ? "animate-pulse pointer-events-none" : ""}
                `}
              >
           ...
           disabled={load}
            ...
            <p className="text-sm text-zinc-400">
              {load ? "Uploading..." : "Click the camera icon to update your photo"}
            </p>
          </div>
